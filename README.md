...
```
# Output Waveform
![image](https://github.com/user-attachments/assets/db0014c5-bea6-4099-802d-66f4b4a6ef2e)

# Results
Thus the ASK (Amplitude Shift Keying) IS PERFORMED USING PHYTON
# Hardware experiment output waveform:
![image](https://github.com/user-attachments/assets/4b7713ba-9008-42a1-990b-f10fbde8839b)
